            ...
            <div class="card-body py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3 name">
                        ...
                        <h6 class="text-muted mb-0">{{ $model->user->role->role_name ?? '-' }} - {{ $model->mapel->nama_mapel ?? '-' }}</h6>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            @if($modelMateri->count())
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('guru.kelola-pembelajaran.diskusi-materi', $materi->id) }}" class="btn btn-outline-primary d-inline-flex"><i class="bi bi-chat me-1"></i>Lihat Diskusi</a>
                                    </td>
                                </tr>
                                @endforeach
                            @else
